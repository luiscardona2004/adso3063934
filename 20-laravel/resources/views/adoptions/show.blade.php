...
@section('content')
    ...
    <div class="bg-[#0009] p-10 rounded-sm">
        ...
        <div class="flex gap-2 flex-col md:flex-row" >
            <ul class="list bg-[#0009] mt-4 text-white rounded-box shadow-md w-64">
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Name:</span> <span class="text-[#fff9]">
                        {{ $adopt->pet->name }}</span>
                </li>
                <li class="list-row">
            ...
            <ul class="list bg-[#0009] mt-4 text-white rounded-box shadow-md w-64">
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Location:</span> <span class="text-[#fff9]">
                        {{ $adopt->pet->location }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Description:</span> <span class="text-[#fff9]">
                        {{ $adopt->pet->description }}</span>
                </li>
                <li class="list-row">
                ...
                <li class="list-row">
                    ...
                    <span>
                        @if ($adopt->pet->status == 0)
                            <div class="badge badge-outline badge-success">Avalaible</div>
                        @else
                ...
                <li class="list-row">
                    ...
                    <span>{{ $adopt->pet->created_at->diffForHumans() }}</span>
                </li>
                <li class="list-row">
                    <span class="text-[#fff9] font-semibold">Update at:</span>
                    <span>{{ $adopt->pet->updated_at->diffForHumans() }}</span>
                </li>
            </ul>
        </div>
    </div>
